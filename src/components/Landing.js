...
function Landing() {
    ...
    return (
        <div className='Landing'>
            ...
            <p>
                <strong>NOBRAC</strong> -- carbon spelled in reverse -- is a non-profit campaign geared towards reducing carbon waste in order to help curve the environmental phenomenon known as global warming. It aims to do this by raising awareness and providing people with the necessary tools and resources to start making meaningful and impactful changes to their everyday lives.
            </p>
            ...
            <p>
                The average carbon footprint for a person in the United States is between 16 and 20 tonnes, which is the highest in the world after China, although recent data suggests a slight decrease in these numbers at about 14 tonnes. However, compared to the global average of about 4.5 tonnes, this improvement is still a drop in the bucket. It is said that in order to avoid a 2°C rise in global temperatures, we must aim to reach under 2 tonnes by 2050.
            </p>
            <p>Ready to find out your carbon footprint?</p>
            <p>Click below to take a quick quiz!</p>
            <div className='link-wrapper'>
