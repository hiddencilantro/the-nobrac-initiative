        ...
        <div className="Tips">
            ...
            <ul>
                ...
                <Collapse in={expand.energy} timeout={500} >
                    <p>
                        We know there aren't many choices in the market for hydro, solar, or wind energy so it's easy to delegate this responsibility to the energy suppliers but it helps if you decide to take initiative. Remember that consumers can collectively play a huge part in how the market moves.
                    </p>
                </Collapse>
                ...
                <Collapse in={expand.veggie} timeout={500} >
                    <p>
                        You might've heard this one before but can eating less meat really help slow global warming? Absolutely. There are so many factors to consider but the most predominant is the level of methane released when treating cattle manure.<br />
