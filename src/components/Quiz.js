...
import PublicTransit from './quiz/transport/PublicTransit';
import Flight from './quiz/transport/Flight';
import Electricity from './quiz/utility/Electricity';
import NaturalGas from './quiz/utility/NaturalGas';
import Water from './quiz/utility/Water';
import Food from './quiz/consumption/Food';
import Beverage from './quiz/consumption/Beverage';
import Dining from './quiz/consumption/Dining';
import Tobacco from './quiz/consumption/Tobacco';
import Goods from './quiz/shopping/Goods';
import Services from './quiz/shopping/Services';
import Recreation from './quiz/shopping/Recreation';
import Results from './quiz/Results';
import NotFound from './NotFound';

function Quiz({setLogin, setCreateSuccess}) {
    useEffect(() => {
    ...
    const handleNext = () => {
        switch(activeStep) {
            ...
            case 2:
                ...
                navigate('/quiz/electricity');
                break;
            case 3:
                navigate('/quiz/natural-gas');
                break;
            case 4:
                navigate('/quiz/water');
                break;
        ...
        <div className='Quiz'>
            ...
            {activeStep !== 13 ? 
                <MobileStepper 
                    ...
                    nextButton={<button onClick={handleNext} disabled={toggle === null} >Next</button>} 
